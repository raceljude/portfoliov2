        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 pt-6 pb-10 sm:px-6 lg:px-8">
          ...
          <section id="contact" className="mt-14 scroll-mt-20">
                ...
                return c.href ? (
                  <a
                    ...
                    onMouseEnter={e => {
                      ...
                      el.style.boxShadow = "0 8px 24px " + c.color + "20";
                    }}
                    onMouseLeave={e => {
                      const el = e.currentTarget as HTMLElement;
                  ...
                  <div key={c.label} className="rounded-xl p-5 flex flex-col" style={cardStyle}>
                    {inner}
                  </div>
                );
              })}
            ...
            <div
              ...
              style={{
                background: "linear-gradient(135deg, " + P.navy + " 0%, #0a2235 100%)",
